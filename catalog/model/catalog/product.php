...
class ModelCatalogProduct extends Model {
	...
	public function getProductOptions($product_id) {
		...
		foreach ($product_option_query->rows as $product_option) {
			...
			WHERE pov.product_id = '" . (int)$product_id . "' AND pov.product_option_id = '" . (int)$product_option['product_option_id'] . "' AND ovd.language_id = '" . (int)$this->config->get('config_language_id') . "' ORDER BY ov.sort_order");
	...
	public function getProductHpmrelated($product_id) {
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "hpmodel_links hpml LEFT JOIN " . DB_PREFIX . "product pml ON (hpml.product_id = pml.product_id) WHERE parent_id = '" . (int)$product_id . "'");
		return $query->rows;
	}

	public function getProductimageoption($prodoptionvalueid) {
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "poip_option_image WHERE product_option_value_id = '" . (int)$prodoptionvalueid . "'");
	...
	public function getVhodnajazad($product_id, $option_vl_id) {
		$queryf = $this->db->query("SELECT pov.image FROM " . DB_PREFIX . "product_option_value pod 
		LEFT JOIN " . DB_PREFIX . "option_value pov ON (pov.option_value_id = pod.option_value_id) 
		WHERE pod.product_id = '" . (int)$product_id . "' AND pov.option_id = '" . (int)$option_vl_id ."'");
		return $queryf;
	}
