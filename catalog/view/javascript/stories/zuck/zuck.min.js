                ...
                E = {
                    ...
                    template: {
                        timelineItem: function(a) {
                            ...
                            return '<div class="story '.concat(!0 === d(a, "seen") ? "seen" : "", '">' +
                                ...
                                '<strong class="name" itemProp="name">').concat(d(a, "name"), '</strong>' +
                    ...
                    language: {
                        unmute: "Нажмите, чтобы обезвучить",
                        keyboardTip: "Нажмите пробел для следующей сторис",
